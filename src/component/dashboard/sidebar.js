          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <button
                ...
                data-collapse-toggle="dropdown-example"
              >
                <PiShoppingBagOpenFill className="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" />
                <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">
                  Products
                </span>
              </button>
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group"
              >
                <GrLogout className="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white"  />
